...
const fieldsV2: FieldDefinition[] = [
  ...
  v2field("employment.company", "Trabajo", "Empresa", "¿Cuál es el nombre completo de la empresa, negocio o institución? Si trabajas por tu cuenta y no tiene nombre comercial, responde SIN NOMBRE.", "text", { applies: hasWork }),
  v2field("employment.position", "Trabajo", "Puesto", "¿Cuál es o era tu puesto, ocupación o actividad principal? Si trabajas por tu cuenta, indica brevemente qué producto vendes o qué servicio realizas.", "text", { applies: hasWork }),
  ...
  v2field("employment.duties", "Trabajo", "Actividades laborales", "Describe brevemente qué haces o hacías: el producto que vendes, servicio que realizas o tus funciones principales.", "text", { applies: hasWork }),
